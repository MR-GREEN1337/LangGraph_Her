...
from utils import load_env, _print_event, handle_tool_error, create_tool_node_with_fallback
import datetime
import climage
import shutil
import uuid
...
class Bot():
    ...
    primary_assistant_prompt = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                "You are a helpful human being to interact with human nature. "
    ...
    tutorial_questions = [
        ...
        "What's my name, what about yours?"
    ]
